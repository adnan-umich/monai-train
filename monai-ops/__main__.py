...
def execute():
    ...
    print("\nThis version of Monai-Ops uses the Pytorch Mixed-Precision acceleration. A side-effect \n \
           of this acceleration is certain combination of hyperparameters can make trials fail \n"
    )
